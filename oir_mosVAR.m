%% Model Order Selection for identification strictly causal VAR model
% (identical to mos_idMVAR funcion of eMVAR toolbox)
...
function [pottaic,pottmdl,aic,mdl] = oir_mosVAR(Y,pmax,idMode)

if nargin < 3, idMode=0; end % default use least squares estimate
